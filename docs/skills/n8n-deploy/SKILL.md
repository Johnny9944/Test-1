...
## 2.x 公共 API 的坑(2026-09-10 由云端从 n8n 源码核实;同日在老板实例实测:R22.9 PUT 后 activeVersionId 由 c17595f4 变为 bdbd698c,即直接上线)
...
- **记录 PUT 前后的 `activeVersionId`。** 变了就是已上线,写进 TASK.md(2026-09-10 R22.9 实测:变了)。
